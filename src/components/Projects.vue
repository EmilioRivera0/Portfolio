...
export default {
    data() {
        return {
            category: "C/C++",
            categories: ["C/C++","Python","JavaScript"],
            projects: [
                //C/C++
                {
        ...
        <div class="flex flex-col md:flex-row w-11/12">
            ...
            <div class="min-[768px]:hidden mb-3">
                <div class="sm:hidden">
                    ...
                    <select id="tabs"
                        class="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:text-white">
                        <option v-for="it in categories">{{ it }}</option>
                    </select>
                </div>
                <ul
            ...
            <div class="grid md:grid-cols-2">
                <div v-for="it in projects" class="flex flex-col items-center min-[1000px]:flex-row md:mx-1 mb-3">
                    <img class="object-cover w-full min-[1000px]:w-1/3 rounded-xl h-96" src="/home/sonny/Downloads/Me.jpg"
                        alt="">
                    <div
                        class="flex flex-col  min-[1000px]:w-2/3 p-4 h-full leading-normal rounded-xl shadow bg-white border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
